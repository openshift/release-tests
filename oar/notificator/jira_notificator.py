...
class NotificationService:
    ...
    def _init_github_app(self) -> GitHubApp | None:
        ...
        Returns:
            GitHubApp instance, or None if credentials are missing.

        Raises:
            Exception: If credentials are set but GitHub App initialization fails.
        """
    ...
    def get_on_qa_filter(self, from_date: Optional[datetime] = None) -> str:
        ...
        base_filter = (
            ...
            "AND status = ON_QA AND 'Target Version' in (4.12.z, 4.13.z, 4.14.z, 4.15.z, 4.16.z, 4.17.z, 4.18.z, 4.19.z, 4.20.z, 4.21.z, 4.22.z, 5.0.z)"
        )
