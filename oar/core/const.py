...
LABEL_BLOCKING_SEC_ALERTS = "A29"
LABEL_BLOCKING_SEC_ALERTS_DROPDOWN = "B29"
LABEL_BUG_FIRST_CELL = "C8"
LABEL_ISSUES_OTHERS_COLUMN = "H"
LABEL_ISSUES_OTHERS_ROW = 8
LABEL_ADVISORY_START_ROW_INDEX = 1
LABEL_ADVISORY_END_ROW_INDEX = 2
LABEL_ADVISORY_START_COL_INDEX = 1
LABEL_ADVISORY_END_COL_INDEX = 2
ALL_TASKS = [
