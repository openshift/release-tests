...
class TestImageConsistencyChecker(unittest.TestCase):
    ...
    def _create_mock_image_metadata(self, digest='', listdigest='', vcs_ref='', name=''):
        ...
        mock.log_pullspec_details = MagicMock()
        return mock
    ...
    def test_create_image_metadata(self, mock_image_metadata_class):
        ...
        mock_payload.get_image_pullspecs.return_value = ['pullspec1', 'pullspec2']
        mock_shipment = MagicMock()
        mock_shipment.get_image_pullspecs.return_value = ['pullspec3', 'pullspec2']

        mock_image_metadata_class.side_effect = lambda ps: MagicMock(pull_spec=ps)

        checker = ImageConsistencyChecker(mock_payload, mock_shipment)
    ...
    def test_is_payload_image_in_shipment_found(self, mock_image_metadata_class):
        ...
        mock_payload = MagicMock()
        mock_payload.get_image_pullspecs.return_value = ['payload_pullspec']
        mock_shipment = MagicMock()
        mock_shipment.get_image_pullspecs.return_value = ['shipment_pullspec']
        ...
        checker = ImageConsistencyChecker(mock_payload, mock_shipment)
        result = checker._is_payload_image_in_shipment('payload_pullspec')
    ...
    def test_is_payload_image_released_found(self, mock_image_metadata_class, mock_requests_get):
        ...
        mock_payload.get_image_pullspecs.return_value = ['payload_pullspec']
        mock_shipment = MagicMock()
        mock_shipment.get_image_pullspecs.return_value = []
        ...
        checker = ImageConsistencyChecker(mock_payload, mock_shipment)
        result = checker._is_payload_image_released('payload_pullspec')
    ...
    def test_find_images_with_same_name(self, mock_image_metadata_class):
        ...
        checker = ImageConsistencyChecker(mock_payload, mock_shipment)
        checker._find_images_with_same_name('payload_pullspec')

        shipment_metadata.log_pullspec_details.assert_called()
    ...
    def test_is_consistent_all_in_shipment(self, mock_image_metadata_class, mock_requests_get):
        ...
        mock_payload = MagicMock()
        mock_payload.get_image_pullspecs.return_value = ['payload1', 'payload2']
        mock_shipment = MagicMock()
        mock_shipment.get_image_pullspecs.return_value = ['shipment1', 'shipment2']
    ...
    def test_is_consistent_all_in_catalog(self, mock_image_metadata_class, mock_requests_get):
        ...
        mock_payload = MagicMock()
        mock_payload.get_image_pullspecs.return_value = ['payload1']
        mock_shipment = MagicMock()
        mock_shipment.get_image_pullspecs.return_value = []
    ...
    def test_is_consistent_not_found(self, mock_image_metadata_class, mock_requests_get):
        ...
        mock_payload.get_image_pullspecs.return_value = ['payload1']
        mock_shipment = MagicMock()
        mock_shipment.get_image_pullspecs.return_value = ['shipment1']
