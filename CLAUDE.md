...
2. **Status check tools** - Query job status (image-consistency-check -i, stage-testing -i)
...
oar -r 4.19.1 stage-testing -i <job-id>  # Check status
...
4. Prow job configuration (image-consistency-check, stage-testing)
